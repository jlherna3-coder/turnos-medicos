...
const EMPTY = { doctorId: '', date: '', startTime: '08:00', endTime: '17:00' }

export default function ShiftModal({ shift, defaultDate, defaultDoctorId, onClose }) {
  const { doctors, addShift, updateShift, deleteShift } = useApp()
  ...
  }, [shift, defaultDate, defaultDoctorId])

  const set = (field) => (e) => setForm((f) => ({ ...f, [field]: e.target.value }))

  const handleSubmit = (e) => {
    e.preventDefault()
    isEdit ? updateShift(shift.id, form) : addShift(form)
    onClose()
  }
